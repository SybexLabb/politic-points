                        ...
                        <div class="form-main">
                            ...
                            <form action="{{ route('contact-submit') }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
                                        <div class="input-main">
                                            <input type="text" class="form-control fm-ctl" placeholder="Last Name"
                    ...
                    <div class="col-12 col-sm-12 col-md-5 col-lg-5 col-xl-5 col-xxl-5">
                        <div class="info-box">
                            <ul>
                                ...
                                <li><a href="mailto:{{ $emailaddress->value }}"
                                        class="msg-ico">{{ $emailaddress->value }}</a></li>
                                <li><a href="tel:{{ $phonenumber->value }}" class="phn-ico">{{ $phonenumber->value }}</a>
                                </li>
                            </ul>
                            <iframe src="{{ $location->value }}" style="border:0;" allowfullscreen="" loading="lazy"
