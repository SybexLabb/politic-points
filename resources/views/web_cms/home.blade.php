                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 mb-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <textarea required class="form-control input-cms" id="description" name="{{ getCMS('home_section1_description','slug') }}">{{ getCMS('home_section1_description', 'value') }}</textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 mb-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <textarea required class="form-control input-cms" id="description" name="{{ getCMS('home_section2_description','slug') }}">{{ getCMS('home_section2_description', 'value') }}</textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 mb-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input required class="form-control input-cms" type="text"
                                                            name="{{ getCMS('home_section5_heading', 'slug') }}"
                                                            value="{{ getCMS('home_section5_heading', 'value') }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 mb-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input required class="form-control input-cms" type="text"
                                                            name="{{ getCMS('home_section6_heading', 'slug') }}"
                                                            value="{{ getCMS('home_section6_heading', 'value') }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 mb-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input required class="form-control input-cms" type="text"
                                                            name="{{ getCMS('home_section7_heading', 'slug') }}"
                                                            value="{{ getCMS('home_section7_heading', 'value') }}">
                                                    </div>
                                                </div>
