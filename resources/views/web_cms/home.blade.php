                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 mb-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input required class="form-control input-cms" type="text"
                                                            name="{{ getCMS('home_section1_description', 'slug') }}"
                                                            value="{{ getCMS('home_section1_description', 'value') }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 mb-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input required class="form-control input-cms" type="text"
                                                            name="{{ getCMS('home_section2_description', 'slug') }}"
                                                            value="{{ getCMS('home_section2_description', 'value') }}">
                                                    </div>
                                                </div>
